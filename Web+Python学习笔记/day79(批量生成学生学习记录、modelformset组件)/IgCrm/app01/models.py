...
Book
   ...
   id    title    price   publsih_id
   1                      
   
   
Publish
   publish_name   publish_email  publish_addr   


StudentStudyRecord

   id  student   cls    day_num   content   homework   teacher    score   checked
    1     A       1         79       crm       crm        C        88        2              
    2     D       1         79       crm       crm        C        67        1              
    3     E       1         79       crm       crm        C        66        1              



StudentStudyRecord

   id  student     score   checked    csr_id
    1     A         88        2          1       
    2     D         67        1          1    
    3     E         66        1          1
    
ClassStudyRecord
 id  cls    day_num   content   homework   teacher
  1  15       79       crm        crm        C
